import{v as We,G as te,x as re,y as Ve,m as se,M as g,E as d,e as D,z as ne,F as _,H as je,R as E,I as ae,J as ie,K as Ne,a as m,S as p,k as B,w as oe,L as $,N as $e,d as q,B as k,l as U,O as M,T as b,Q as S,V as qe,c as Ke,C as w,W as le,X as de,Y as ue,Z as ce,_ as Ye,P as Je,h as Xe,b as K,D as he,$ as Y,a0 as Qe,a1 as Ze,a2 as et}from"./index-BmOUp0N2.js";import{S as fe,T as J,B as tt,c as rt}from"./colorToUniform-tGcQTTk_.js";const pe=class A extends We{constructor(e){e={...A.defaultOptions,...e},super(e),this.enabled=!0,this._state=fe.for2d(),this.blendMode=e.blendMode,this.padding=e.padding,typeof e.antialias=="boolean"?this.antialias=e.antialias?"on":"off":this.antialias=e.antialias,this.resolution=e.resolution,this.blendRequired=e.blendRequired,this.addResource("uTexture",0,1)}apply(e,t,r,n){e.applyFilter(this,t,r,n)}get blendMode(){return this._state.blendMode}set blendMode(e){this._state.blendMode=e}static from(e){const{gpu:t,gl:r,...n}=e;let a,i;return t&&(a=te.from(t)),r&&(i=re.from(r)),new A({gpuProgram:a,glProgram:i,...n})}};pe.defaultOptions={blendMode:"normal",resolution:1,padding:0,antialias:"off",blendRequired:!1};let st=pe;var nt=`in vec2 vMaskCoord;
...
fn mainFragment(
  ...
  @builtin(position) position: vec4<f32>
    ...
    `];let a=0;for(let l=0;l<s.length;l++){const o=s[l],u=o.data.name;let c=!1,h=0;for(let f=0;f<C.length;f++)if(C[f].test(o.data)){h=o.offset/4,n.push(`name = "${u}";`,`offset += ${h-a};`,C[f][e]||C[f].ubo),c=!0;break}if(!c)if(o.data.size>1)h=o.offset/4,n.push(t(o,h-a));else{const f=r[o.data.type];h=o.offset/4,n.push(`
                    v = uv.${u};
                    offset += ${h-a};
                    ${f};
                `)}a=h}const i=n.join(`
